...
class BO_algo():
    def __init__(self):
        ...
        ## Define the mapping functions for f and v
        self.f_map = GaussianProcessRegressor(kernel=kernel_f, alpha=0.15, optimizer=None)
        self.v_map = GaussianProcessRegressor(kernel=kernel_v, alpha=0.15, optimizer=None)
